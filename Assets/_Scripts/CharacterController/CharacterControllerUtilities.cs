...
namespace FireFighter.CharacterController
{
    ...
    public static class CharacterControllerUtilities
    {
        ...
        public static unsafe void CheckSupport(
            ...
            out CharacterSupportStateEnum characterState, out float3 surfaceNormal, out float3 surfaceVelocity)
        {
            ...
            {
                characterState = CharacterSupportStateEnum.Unsupported;
                return;
            }
            ...
            // Check support state
            {
                ...
                else if (math.lengthsq(outVelocity) < k_SimplexSolverEpsilonSq)
                {
                    ...
                    characterState = CharacterSupportStateEnum.Supported;
                }
                else
                {
                    ...
                    {
                        characterState = CharacterSupportStateEnum.Sliding;
                    }
                    else
                    {
                        characterState = CharacterSupportStateEnum.Supported;
